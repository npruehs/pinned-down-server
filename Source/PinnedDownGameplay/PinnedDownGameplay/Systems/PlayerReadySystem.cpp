...
void PlayerReadySystem::InitSystem(Game* game)
{
	...
	this->game->eventManager->AddListener(this, PlayerReadyAction::PlayerReadyActionType);
...
{
	CALL_EVENT_HANDLER(PlayerReadyAction);
...
EVENT_HANDLER_DEFINITION(PlayerReadySystem, PlayerReadyAction)
{
	this->playerReady[data.sender] = data.ready;
